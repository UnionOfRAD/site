...
git clone --branch 1.0 https://github.com/UnionOfRAD/manual.git $DOCS_PATH/manual_10
git clone --reference $DOCS_PATH/manual_10 --branch 1.1 https://github.com/UnionOfRAD/manual.git $DOCS_PATH/manual_11
